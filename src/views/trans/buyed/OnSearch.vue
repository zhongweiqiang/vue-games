          ...
          <a-row style="margin-left: 10px;">
            <a-col :span="14">
              <a-row>
                ...
                <a-col :xs="24" :sm="24" :md="18" :lg="12" :xl="8" style="margin-top: 10px;">
                  <a-form-item>
                    <a-input placeholder="恭喜发财" size="small" allowClear></a-input>
                  </a-form-item>
                </a-col>
                <a-col :xs="24" :sm="24" :md="18" :lg="12" :xl="8" style="margin-top: 10px;">
                  <a-form-item>
            ...
            <a-col :style="{marginTop: '10px'}" :xs="20" :sm="16" :md="10" :lg="1" :xl="1">
              <a-form-item>
                <a-button size="small" type="primary" html-type="submit">搜索</a-button>
                <a-button type="primary" size="small" style="margin-top: 10px;" @click="saleList">出售列表</a-button>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
